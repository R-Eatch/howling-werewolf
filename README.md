...
This branch contains the NeoForge edition of Howling Werewolf for Minecraft 1.21.1. The maintained Forge 1.20.1 source is available on the [`1.20.1-forge`](https://github.com/R-Eatch/howling-werewolf/tree/1.20.1-forge) branch.
...
The Gradle wrapper builds the Mod with a Java 21 toolchain:
...
The NeoForge port compiles successfully and has passed its automated dedicated-server regression checks in the private development workspace. Interactive client, complete gameplay, multiplayer, and copied-world upgrade testing remain release gates for the beta line.

Published registry IDs, translation keys, commands, configuration keys, and the legacy player-data recovery key remain compatible with the Forge edition wherever Minecraft 1.21.1 permits.
