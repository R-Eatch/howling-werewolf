...
public final class HWConfig {
    ...
    public static final ModConfigSpec.DoubleValue HUNTER_SPAWN_WEIGHT_MULTIPLIER;
    public static final ModConfigSpec.DoubleValue FERAL_WEREWOLF_SPAWN_WEIGHT_MULTIPLIER;
