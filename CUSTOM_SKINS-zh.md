...
适用于 **月厄狼人 1.1.3 · Minecraft 1.21.1 NeoForge**。无需安装额外 Mod。
...
- 将 `pack.mcmeta`、`assets` 等文件压缩到 ZIP 根目录，发给朋友放入自己的 `resourcepacks` 并启用。双方还需要安装 1.1.3 Mod。服务器也可以通过原版服务器资源包分发功能提供同一个包。
